...
par(mfrow = c(2,2))
plot(classi_empiriche, Flavoro, type="b", 
     main="Funzione di distribuzione empirica discreta di lavoro", col="red")
abline(h=0.5, lty=2, col="blue")
plot(classi_empiriche, Ffamiglia, type="b", 
     main="Funzione di distribuzione empirica discreta di famiglia", col="red")
abline(h=0.5, lty=2, col="blue")
plot(classi_empiriche, Fasilo, type="b", 
     main="Funzione di distribuzione empirica discreta di asilo", col="red")
abline(h=0.5, lty=2, col="blue")
plot(classi_empiriche1, Fstudio, type="b", 
     main="Funzione di distribuzione empirica discreta di studio", col="red")
abline(h=0.5, lty=2, col="blue")
plot(classi_empiriche1, Faltro, type="b", 
     main="Funzione di distribuzione empirica discreta di altro", col="red")
abline(h=0.5, lty=2, col="blue")
```
...
tipiquartili <- function(x){
  ...
  for(i in 1:9){
    y<-rbind(y, c(quantile(x, 0, type=i), quantile(x, 0.25, type=i), 
                  quantile(x, 0.5, type=i), quantile(x, 0.75, type=i), quantile(x, 1, type=i)))
  }
...
```{r}
plot(c(0, hls$height), seq(20, 1), type = "b", main = "Screenplot", 
...
plot(c(0, hlc$height), seq(20, 1), type = "b",
     main = "Screenplot", xlab = "Distanza di aggregazione", 
