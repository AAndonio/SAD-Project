...
Per utilizzare questa metrica, bisogna dare *"minkowski"* come valore all'attributo *method* della funzione *dist()*. 

```{r}
dist(x, method = "minkowski", diag = FALSE, upper=FALSE)
```
