...
#### Verifica ipotesi sulla varianza $\sigma^2$ con valore medio $\mu$ noto

#### Verifica ipotesi sulla varianza $\sigma^2$ con valore medio $\mu$ NON noto
...
Per garantire che ogni classe contenga in media almeno 5 elementi, riteniamo valida l'approssiamzione se
...
- si rifiuti l'ipotesi $H_0$ se $X^2<X^{2}_{1-\alpha/2, r-k-1}$ oppure $X^2>X^{2}_{\alpha/2, r-k-1}$
- si accetti l'ipotesi se $H_0$ se $X^{2}_{1-\alpha/2, r-k-1}<X^2<X^{2}_{\alpha/2, r-k-1}$

dove $X^{2}_{1-\alpha/2, r-k-1}$ e $X^{2}_{\alpha/2, r-k-1}$ sono soluzioni delle equazioni:

$$P(Q < X^{2}_{1-\alpha/2, r-k-1}) = \frac{\alpha}{2}, \qquad P(Q<X^{2}_{\alpha/2, r-k-1}) = 1 - \frac{\alpha}{2}$$
...
Procediamo dunque nel calcolo di $X^{2}_{1-\alpha/2, r-k-1}$ e $X^{2}_{\alpha/2, r-k-1}$ con $\alpha=0.05$.
...
Siccome $X² = 0.422$ risulta essere compresa fra $X^{2}_{1-\alpha/2, r-k-1} = 7.377759$ e $X^{2}_{\alpha/2, r-k-1} = 0.05063562$, l'ipotesi $H_0$ di popolazione normale può essere accettata.
