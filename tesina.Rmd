...
meancamp1 <- mean(campione)
meancamp2 <- mean(campione2)
...
meancamp1-meancamp2 -qnorm (1- alpha/2,mean=0, sd=1)*sqrt(sigmacamp1 ^2/ncamp1+sigmacamp2 ^2/ncamp2)
...
Il problema si riduce quindi a determinare un test che ci permetta di suddividere l'insieme dei possibili campioni in due sottoinsiemi detti **regione di accettazione** $A$ dell'ipotesi nulla ed una **regione di rifiuto** $R$ dell'ipotesi nulla. 